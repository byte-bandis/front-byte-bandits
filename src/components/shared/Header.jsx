...
const Header = () => {
    ...
    return (
        <>
            ...
            <HeaderStyledContainer $CustomMargin=' 10px auto' $CustomPadding='0px' $CustomWidth='80%'  >
                <Logo
                    $CustomWidth='10%'
                    $customImageWidth='80%'
                ...
                >
                    <StyledNav className='nav' $CustomGap='10px' $CustomJustifyContent='space-between'>
                    ...
                    <StyledTagsNavContainer $CustomGap='10px' $CustomJustifyContent='space-between'>
                        <DropdownLink
                            options={TAG_OPTIONS}
...
const HeaderStyledContainer = styled.div`
    ...
    justify-content: ${(props) =>
        props.$CustomJustifyContent || 'space-between'};
...
const StyledTagsNavContainer = styled.div`
    ...
    @media (max-width: 768px) {
        ...
        .TagsNavegation {
            justify-content: ${(props) =>
                props.$CustomJustifyContent || 'center'};
        }
    }
`;
